...
while(True):
    ...
    if(x == 0):
        ...
        print()
        while(True):
            print("Press 1 to create a department\nPress 2 to view all betches in a department\nPress 3 to view average performance of all betches in a department\nPress 4 to view line plot of department statistics\nPress 0 to return to main menu")
            y = int(input("Enter your choice: "))
            if(y == 0):
                break
            elif(y == 1):
